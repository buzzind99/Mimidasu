...
enum ProcessTapFactory {
    ...
    static func createTap(
        ...
        description.name = "Mimidasu system audio tap"
    ...
    /// Mimidasu's own HAL process object, for exclusion from the global tap.
    ...
    static func createAggregateDevice(for tap: Tap) throws(CaptureError) -> AudioDeviceID {
        let composition: [String: Any] = [
            kAudioAggregateDeviceNameKey: "Mimidasu System Audio Capture",
            kAudioAggregateDeviceUIDKey: "mimidasu.capture.\(UUID().uuidString)",
